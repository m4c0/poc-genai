...
namespace gpt2::stages {
  ...
  public:
    smax1(vee::physical_device pd, vee::buffer::type in, vee::buffer::type mx) {
      ...
      m_dpool = vee::create_descriptor_pool(2, { vee::storage_buffer(6) });
      ...
      vee::update_descriptor_set_with_storage(m_ds0, 1, mx);
      vee::update_descriptor_set_with_storage(m_ds0, 2, *m_out);
      vee::update_descriptor_set_with_storage(m_ds1, 0, *m_out);
      vee::update_descriptor_set_with_storage(m_ds1, 1, mx);
      vee::update_descriptor_set_with_storage(m_ds1, 2, *m_out);
    };
